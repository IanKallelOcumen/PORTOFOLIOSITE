      ...
      <motion.div variants={itemVariants} className="col-span-1 md:col-span-2" id="about">
        <Card mousePosition={mousePosition}>
          ...
          <div className="flex flex-wrap gap-2 mt-6 md:mt-8">
            ...
            <Tag><Users className="w-3.5 h-3.5" /> Appointment Setter (BPO)</Tag>
          </div>
        ...
        <Card mousePosition={mousePosition}>
          ...
          <div className="space-y-6">
            ...
            <div className="relative pl-6 border-l-2 border-white/10">
              ...
              <h3 className="text-base md:text-lg font-bold mb-1">Appointment Setter (BPO)</h3>
              <p className="text-sm text-[#888]">Virtual Champs Global Inc • Lead qualification & scheduling</p>
            </div>
            <div className="relative pl-6 border-l-2 border-white/10">
              <div className="absolute -left-[5px] top-1 w-2 h-2 bg-white/30 rounded-full" />
            ...
            <div>
              <div className="flex items-start justify-between mb-2">
                <div>
                  ...
                  <p className="text-sm text-[#888]">Graduated June 12, 2026</p>
                </div>
                <Tag className="text-xs">GRADUATED</Tag>
              </div>
              <p className="text-sm text-[#666] leading-relaxed">
                Bachelor of Science in Information Technology focused on web development, systems design, and technical problem-solving.
              </p>
            </div>
      ...
      >
        <Card mousePosition={mousePosition}>
          <GitHubProjects
            ...
            excludeRepos={['PORTOFOLIOSITE', 'VALENTINESDAY']}
