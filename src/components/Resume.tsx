...
<body>
  <div class="container">
    ...
    <div class="header">
      ...
      <p class="subtitle">BS Information Technology Graduate | Multi-Disciplinary Creator</p>
      ...
      <div>
        ...
        <div class="section">
          ...
          <p class="profile-text">
            Creative BSIT graduate with <strong>4 years of digital art experience</strong> and a passion for modern web development. 
        ...
        <div class="section">
          ...
          <div class="skill-category">
            <div class="skill-title">📞 BPO & Sales Support</div>
            <div class="skill-tags">
              <span class="skill-tag">Appointment Setting</span>
              <span class="skill-tag">Lead Qualification</span>
              <span class="skill-tag">Cold Outreach</span>
              <span class="skill-tag">CRM Updates</span>
        ...
        <div class="section">
          ...
          <div class="education-item">
            ...
            <div class="education-subtitle">Graduated June 12, 2026</div>
      ...
      <div>
        ...
        <div class="section">
          ...
          <div class="experience-item">
            <div class="experience-header">
              <div>
                <div class="experience-title">Appointment Setter (BPO)</div>
                <div class="experience-company">Virtual Champs Global Inc</div>
              </div>
              <div class="experience-date">Jan 2026 - Apr 2026</div>
            </div>
            <ul class="experience-list">
              <li>Scheduled appointments and qualified leads through outbound outreach and follow-ups</li>
              <li>Maintained clear, professional communication and ensured accurate client information</li>
              <li>Tracked conversations and outcomes for handoff to the sales team</li>
            </ul>
          </div>
            ...
            <section>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm text-gray-700 ml-2">
                    <li>
                      Scheduled appointments and qualified
                      leads through outbound outreach and
                      follow-ups
                    </li>
                    <li>
                      Maintained clear, professional
                      communication and ensured accurate client
                      information
                    </li>
                    <li>
                      Tracked conversations and outcomes for
